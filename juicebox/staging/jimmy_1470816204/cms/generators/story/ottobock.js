	...
	modules: [
		{
			...
			context: {
				...
				background_img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467232237_01.jpg',
				...
				jumbotext: 'A story about immersion.'
			}
		},
		{
			$module_type_type: 'title',
				...
				columns: [
					{
						...
						context: {
							header: '',
							title: '[Designing]{designprocess} for the real meaning of “Quality of Life”.',
							$text_type: 'textarea',
				...
				columns: [
					{
						...
						context: {
							header: '',
							title: '[Can you think of]{challenger} a product with a more personal connection to the user?',
							$text_type: 'textarea',
				...
				squares: [
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467232192_01.jpg',
							dark: false,
							tagline: '',
							title: '',
							text: '',
					...
					},
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467231843',
							dark: false,
							tagline: '',
							title: '',
							text: '',
					...
					},
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467231849',
							dark: false,
							tagline: '',
							title: '',
							text: '',
					...
					},
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467231857',
							dark: false,
							tagline: '',
							title: '',
							text: '',
					...
					},
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467231875',
							dark: false,
							tagline: '',
							title: '',
							text: '',
				...
				columns: [
					{
						...
						context: {
							header: '',
							title: 'The GENIUM Protector adds form and [function]{specialist} to a prosthetic knee.',
							$text_type: 'textarea',
							text: '',
							purelink: ''
						}
		...
		},
		{
			...
			context: {
				$background_img_type: 'image',
				$background_img_label: 'Background image',
				background_img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467232266_05.jpg',
				$background_video_type: 'image',
				background_video: '',
				$veil_info: 'Select opacity of the veil.',
				$veil_type: 'slider',
				...
				columns: [
					{
						...
						context: {
							header: '',
							title: 'Redefining Ottobock‘s design [DNA]{heritage} for the healthcare sector of prosthetics.',
							$text_type: 'textarea',
							text: '',
							purelink: ''
						}
				...
				squares: [
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467268036_01.jpg',
							dark: false,
							tagline: '',
							title: '',
							text: '',
					...
					},
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467268049_02.jpg',
							dark: false,
							tagline: '',
							title: '',
							text: '',
					...
					},
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467268057_03.jpg',
							dark: false,
							tagline: '',
							title: '',
							text: '',
					...
					},
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467268066_04.jpg',
							dark: false,
							tagline: '',
							title: '',
							text: '',
					...
					},
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467286878_ottobock.jpg',
							dark: false,
							tagline: '',
							title: '',
							text: '',
				...
				columns: [
					{
						...
						context: {
							header: '',
							title: 'It’s about more than designing products. [Meaningful designs]{transparency} are rooted in personal stories.',
							$text_type: 'textarea',
							text: '',
							purelink: ''
						}
				...
				squares: [
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467268239_01.jpg',
							dark: false,
							tagline: '',
							title: '',
							text: '',
					...
					},
					{
						...
						context: {
							$img_type: 'image',
							img: 'https://s3-eu-west-1.amazonaws.com/enduro.static/direct_uploads/1467268249_02.jpg',
							dark: false,
							tagline: '',
							title: '',
							text: '',
				...
				columns: [
					{
						...
						$context_noframe: true,
						context: {
							header: 'Empathize with us!',
							title: 'Let’s create meaningful impact.',
							$text_type: 'textarea',
							text: '',
							link: 'Get in touch'
						}
